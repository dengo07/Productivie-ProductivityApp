...
function LandingPage() {
  ...
  const joinOurCom = (<div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-8 rounded-3xl border border-primary/20">
  ...
  return (
    <div
      data-theme={theme}
      className="min-h-screen bg-gradient-to-br from-primary/20 via-base-100 to-secondary/20 transition-all duration-1000 overflow-hidden relative"
    >
      ...
      <div className="navbar bg-base-100/80 backdrop-blur-xl shadow-2xl border-b border-primary/20 sticky top-0 z-50">
        ...
        <div className="navbar-end gap-3">
          ...
          <a 
            href="/app" 
            className="btn btn-primary btn-lg hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-2xl bg-gradient-to-r from-primary to-secondary border-0 group"
          >
      ...
      <div className="hero min-h-screen relative">
        <div className="hero-content flex-col lg:flex-row gap-12 max-w-7xl">
          ...
          <div className={`relative transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`}>
            ...
            <div className="relative bg-gradient-to-br from-base-200 to-base-300 p-8 rounded-2xl shadow-2xl border border-primary/20">
              <img
                src="hero-sec-photo.png"
                className="max-w-md rounded-xl shadow-xl hover:scale-105 transition-transform duration-500"
          ...
          <div className={`max-w-2xl transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'}`}>
            ...
            <p className="text-xl lg:text-2xl py-8 leading-relaxed text-base-content/80">
      ...
      <section className="py-32 px-6 bg-gradient-to-b from-base-100 to-base-200 relative">
            ...
            {[
              {
                ...
                description: "Improve productivity with simple Pomodoro sessions.",
              ...
              },
              {
                icon: Kanban,
                title: "Kanban Board",
                description: "Track your workflow with clean, customizable Kanban-style boards.",
              ...
              },
              {
                icon: Brain,
                title: "Mind Map",
                description: "Map out your thoughts on an infinite canvas — export and share with ease.",
              ...
              },
              {
                icon: ListTodo,
                title: "To-Do List",
                description: "Plan, prioritize, and progress — all in one streamlined task list.",
              ...
              },
              {
                icon: Focus,
                title: "Daily Focus",
                description: "Set your daily motivation and track your progress toward goals",
                ...
                description: "Don't forget to tell us what you need",
                color: "from-orange-500 to-yellow-500",
                bgColor: "bg-orange-500/10"
              },
      ...
      {/* About Section */}
      <section className="py-32 px-6 bg-gradient-to-b from-base-200 to-base-100 relative">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-base-300 to-base-200 p-12 rounded-3xl shadow-2xl border border-primary/20">
                <div className="text-center space-y-8">
                  <div className="grid grid-cols-2 gap-8">
                    ...
                    <div className="text-center">
                      <div className="text-4xl font-black text-secondary mb-2">6</div>
                    ...
                    <div className="text-center">
                      <div className="text-4xl font-black text-warning mb-2">24/7</div>
      ...
      <section className="py-32 bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-6 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a 
              href="/app" 
              className="btn btn-primary btn-lg text-xl px-12 py-4 hover:scale-110 transition-all duration-300 shadow-2xl bg-gradient-to-r from-primary to-secondary border-0 group relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
      ...
      <footer className="footer footer-center bg-gradient-to-t from-base-300 to-base-200 text-base-content p-16 border-t border-primary/20">
        ...
        <nav className="grid grid-flow-col gap-8 text-lg">
